...
Elm.Natureza0d0d2 = Elm.Natureza0d0d2 || {};
Elm.Natureza0d0d2.make = function (_elm) {
   "use strict";
   _elm.Natureza0d0d2 = _elm.Natureza0d0d2 || {};
   if (_elm.Natureza0d0d2.values)
   return _elm.Natureza0d0d2.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   _E = _N.Error.make(_elm),
   $moduleName = "Natureza0d0d2";
   var Basics = Elm.Basics.make(_elm);
   var Color = Elm.Color.make(_elm);
   var FpsCounter = Elm.FpsCounter.make(_elm);
   ...
   var _op = {};
   var myCounter = A2(FpsCounter.fpsCounter,
   30,
   30);
   var view = F3(function (dimensions,
   position,
   map) {
      return A2(Graphics.Collage.collage,
      A2(Basics.min,
      Basics.fst(dimensions),
      NConst.mapSize),
      A2(Basics.min,
      Basics.snd(dimensions),
      NConst.mapSize))(NMap.drawMap(map));
   });
   ...
   var updateMap = F2(function (mouse,
   map) {
      return map;
   });
   var map = Signal.constant(NModel.initialMap);
   var main = A2(Signal._op["<~"],
   layout,
   Signal.combine(_L.fromArray([myCounter
                               ,A2(Signal._op["~"],
                               A2(Signal._op["~"],
                               A2(Signal._op["<~"],
                               view,
                               ...
                               Mouse.position),
                               map)])));
   _elm.Natureza0d0d2.values = {_op: _op
                               ,map: map
                               ,updateMap: updateMap
                               ,layout: layout
                               ,view: view
                               ...
                               ,main: main};
   return _elm.Natureza0d0d2.values;
};Elm.FpsCounter = Elm.FpsCounter || {};
Elm.FpsCounter.make = function (_elm) {
   "use strict";
   _elm.FpsCounter = _elm.FpsCounter || {};
   if (_elm.FpsCounter.values)
   return _elm.FpsCounter.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   _E = _N.Error.make(_elm),
   $moduleName = "FpsCounter";
   var Basics = Elm.Basics.make(_elm);
   var Color = Elm.Color.make(_elm);
   var Graphics = Graphics || {};
   Graphics.Collage = Elm.Graphics.Collage.make(_elm);
   ...
   var Time = Elm.Time.make(_elm);
   var _op = {};
   var remember = function (t) {
      return A2(Signal.foldp,
      F2(function (x,xs) {
         return {ctor: "::"
                ,_0: 1000 / x
                ,_1: A2(List.take,t - 1,xs)};
      }),
      _L.fromArray([]));
   };
   var sixty = _L.fromArray([1
                            ,2
                            ,3
                            ,4
                            ,5
   ...
   var createFpsCounter = F2(function (f,
   xs) {
      return A2(Graphics.Element.beside,
      A3(Graphics.Collage.collage,
      List.length(xs),
      f,
      _L.fromArray([Graphics.Collage.traced(Graphics.Collage.solid(Color.black))(Graphics.Collage.path(A3(List.zipWith,
      F2(function (x,y) {
         return {ctor: "_Tuple2"
                ,_0: y - 30
                ,_1: x - 35};
      ...
      xs,
      sixty)))])),
      Text.plainText(A2(String.left,
      5,
      String.show(average(xs)))));
   });
   var fpsCounter = F2(function (f,
   n) {
      return A2(Signal._op["<~"],
      createFpsCounter(f),
      A2(Signal.sampleOn,
      Time.fps(3),
      A2(remember,n,Time.fps(f))));
   });
   _elm.FpsCounter.values = {_op: _op
                            ,fpsCounter: fpsCounter
                            ,createFpsCounter: createFpsCounter};
   return _elm.FpsCounter.values;
};Elm.NMap = Elm.NMap || {};
Elm.NMap.make = function (_elm) {
      ...
      return function () {
         ...
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: A2(Basics.div,
                   Basics.round(_v0._0),
                   NConst.imgSize) + NConst.iOffset
                   ,_1: -1 * (A2(Basics.div,
                   Basics.round(_v0._0),
                   NConst.imgSize) - NConst.iOffset)};}
         _E.Case($moduleName,
         "on line 13, column 23 to 125");
      }();
   };
   var atPos = function (_v4) {
      return function () {
         switch (_v4.ctor)
         {case "_Tuple2":
            return {ctor: "_Tuple2"
                   ,_0: Basics.toFloat((_v4._0 - NConst.iOffset) * NConst.imgSize)
                   ,_1: Basics.toFloat((NConst.iOffset - _v4._1) * NConst.imgSize)};}
         _E.Case($moduleName,
         "on line 10, column 17 to 105");
      }();
   };
   ...
   _elm.NMap.values = {_op: _op
                      ...
                      ,drawMap: drawMap};
   return _elm.NMap.values;
};Elm.NModel = Elm.NModel || {};
Elm.NModel.make = function (_elm) {
   "use strict";
   _elm.NModel = _elm.NModel || {};
   if (_elm.NModel.values)
   return _elm.NModel.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   ...
   var emptyTile = {_: {}
                   ,src: NConst.sandTile};
   var initialMap = A2(Array.repeat,
   NConst.mapLen,
   A2(Array.repeat,
   NConst.mapLen,
   emptyTile));
   ...
   _elm.NModel.values = {_op: _op
                        ,emptyTile: emptyTile
                        ,initialMap: initialMap
                        ,Tile: Tile};
   return _elm.NModel.values;
};Elm.NConst = Elm.NConst || {};
Elm.NConst.make = function (_elm) {
   "use strict";
   _elm.NConst = _elm.NConst || {};
   if (_elm.NConst.values)
   return _elm.NConst.values;
   var _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   _A = _N.Array.make(_elm),
   ...
   var Time = Elm.Time.make(_elm);
   var _op = {};
   var selection = "http://mysterymachine.github.io/images/selection0d0d2.gif";
   var treeTile = "http://mysterymachine.github.io/images/tree0d0d2.gif";
   var stoneTile = "http://mysterymachine.github.io/images/stone0d0d2.gif";
   var groundTile = "http://mysterymachine.github.io/images/ground0d0d2.gif";
   var grassTile = "http://mysterymachine.github.io/images/grass0d0d2.gif";
   var sandTile = "http://mysterymachine.github.io/images/sand0d0d2.gif";
   var imgSize = 16;
   var mapLen = 25;
   var iOffset = A2(Basics.div,
   mapLen,
   2);
   var mapSize = mapLen * imgSize;
   _elm.NConst.values = {_op: _op
                        ,mapLen: mapLen
                        ,iOffset: iOffset
                        ,imgSize: imgSize
                        ,mapSize: mapSize
